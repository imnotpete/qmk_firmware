...
* |------+------+------+------+------+------+------+------+------+------+------+------|
* | Ctrl |Adjust| GUI  | Alt  |Lower |FnSpce|FnSpce|Raise | Home | PgDn | PgUp | End  |
* `-----------------------------------------------------------------------------------'
*/
[_QWERTY] = KEYMAP( \
...
void dance_tab_esc(qk_tap_dance_state_t *state, void *user_data) {
		if (state->count == 1) {
...
qk_tap_dance_action_t tap_dance_actions[] = {
		[TD_TAB_ESC] = ACTION_TAP_DANCE_FN(dance_tab_esc)
};
