 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |TabNum|   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  |   P  |  \   |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |EscCtl|   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  "   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      | GUI  |Alt |FnSpce|FnSpce|Raise | CAD  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  NUMPAD,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
  TD_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT, \
  _______, _______, _______, KC_LGUI, KC_LALT, FN_SPC,  FN_SPC,  RS_SPC,  CAD    , _______, _______, _______ \
),
...
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |TabPrv|      |Ctrl-W|      |Ctrl-T|      |      | PgUp | Home | PgDn | PScr | Del  |
* |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_FN] = KEYMAP( \
	...
	TBPRV,   _______, CTRLW,   _______, CTRLT,   _______, _______, KC_PGUP, KC_HOME, KC_PGDN, KC_PSCR, KC_DEL, \
